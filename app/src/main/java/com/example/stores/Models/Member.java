...
//    "SELECT m.memberID, m.fullname, m.phoneNumber, m.address, sum(d.quantity)\n" +


    public Member(int memberID, int memberImageURI, String fullname, String phoneNumber, String address, int borrowQuantity) {
