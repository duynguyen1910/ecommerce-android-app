...
public class toastMessage {
    ...
    public static final String LOGIN_FAILED = "Đăng nhập không thành công";
    public static final String REGISTER_SUCCESSFULLY = "Đăng ký tài khoản thành công";
    public static final String REGISTER_FAILED = "Đăng ký tài khoản không thành công";
