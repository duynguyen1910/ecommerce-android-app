...
public enum OrderStatus {
    ...
    NEW(OrderStatus.NEW_LABEL, OrderStatus.NEW_VALUE),
    ...
    private static final int PENDING_CONFIRMATION_VALUE = 2;
    private static final int PENDING_SHIPMENT_VALUE = 3;
    private static final int IN_TRANSIT_VALUE = 4;
    private static final int DELIVERED_VALUE = 5;


    private static final String CANCELLED_LABEL = "Đã hủy";
    private static final String NEW_LABEL = "Mới";
